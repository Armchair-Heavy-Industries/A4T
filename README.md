...
| 1   | Hotend                                        | Recommended hotend:<br/>*  **Dragon HF** with **Triangle Lab ZS-MZE-HF** (<a href="https://www.aliexpress.com/item/1005006402646093.html">Ali Express</a>)<img src='docs/images/DragonHF+MZE.png' width=120 alt="Dragon" align='right'> <br/> Alternatives: <br/>* Dragon UHF or UHF-Mini <br/>* Dragon Ace<br/>* Rapido HF or UHF<br/>* NF-Crazy with MZE<br/>* NF-Crazy Volcano <br/>* Revo-Voron `Unverified, and has different/undocumented LED harness`<br/>* Bambulab `Unverified, and has different/undocumented LED harness`        |
